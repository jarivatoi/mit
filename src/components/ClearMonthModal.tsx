        ...
        <div className="flex-1 overflow-y-auto p-6">
          <div className="space-y-4">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <ul className="text-sm text-orange-700 space-y-1">
                    <li>• This will remove ALL shifts and data for the entire month</li>
                    <li>• This action cannot be undone</li>
                    <li>• Consider exporting data first if you need to keep records</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <p className="text-sm text-gray-700">
              Are you sure you want to clear all data for {monthNames[month]} {year}?
            </p>
          </div>
        </div>
        ...
        <div className="border-t border-gray-200 p-6 flex-shrink-0">
          <div className="flex space-x-3">
            ...
            <button
              ...
              disabled={isClearing}
              className="flex-1 px-4 py-3 bg-orange-600 hover:bg-orange-700 text-white rounded-lg font-medium transition-colors duration-200 disabled:opacity-50 flex items-center justify-center space-x-2"
            >
              {isClearing ? (
                <>
